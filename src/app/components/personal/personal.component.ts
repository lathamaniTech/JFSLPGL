...
export class PersonalComponent implements OnInit {
  ...
  constructor(public navCtrl: NavController,
    ...
    public formBuilder: FormBuilder, public sqliteProvider: SqliteService,
    public alertCtrl: AlertController, public globalData: DataPassingProviderService,
    public http: HTTP, public activateRoute: ActivatedRoute,
    // public viewCtrl: ViewController,
    public loadCtrl: LoadingController, public network: Network,
  ...
  private childConstructor(value) {
    ...
    this.applicantDetails = this.formBuilder.group({
      ...
      spouseName: ["", Validators.compose([Validators.maxLength(30), Validators.pattern('[a-zA-Z ]*')])],
      gender: ["", Validators.required],
      mobNum: ["", Validators.compose([Validators.maxLength(10), Validators.pattern('[0-9]{10}$'), Validators.required])],
      altMobNum: ["", Validators.compose([Validators.maxLength(10), Validators.pattern('[0-9]{10}$')])],
    ...
    if (this.naveParamsValue.lmsData) {
      ...
      this.personalData = this.formBuilder.group({
        genTitle: ['', Validators.required],
        firstname: [this.LMSDetails.promoter_fname, Validators.compose([Validators.maxLength(30), Validators.pattern('[a-zA-Z ]*'), Validators.required])],
        lastname: [this.LMSDetails.promoter_lname, Validators.compose([Validators.maxLength(30), Validators.pattern('[a-zA-Z ]*'), Validators.required])],
        fathername: ['', Validators.compose([Validators.maxLength(30), Validators.pattern('[a-zA-Z ]*'), Validators.required])],
        constitution: [''],
        mothername: ['', Validators.compose([Validators.maxLength(30), Validators.pattern('[a-zA-Z ]*'), Validators.required])],
        dobAadhar: "",
        ...
        gender: ['', Validators.required],
        marital: ['', Validators.required],
        aadharNum: ['', Validators.compose([Validators.maxLength(12), Validators.pattern('[0-9]{12}')])],
        panNum: "",
        docName: "",
        docValue: "",
        mobNum: [this.LMSDetails.mobile_number, Validators.compose([Validators.maxLength(10), Validators.pattern('[0-9]{10}$'), Validators.required])],
        enteredOTP: "",
        employment: ['', Validators.required], // Validators.required
        annualIncome: ['', Validators.required],
      ...
      if (!this.naveParamsValue.pan) {
        this.sqliteProvider.getGivenKarzaDetailsByLeadid(this.leadId).then(value => {
          console.log(value);
          if (value.length) {
            ...
            if (idType) {
              ...
              this.applicantDetails.controls.panNum.setValue(this.globFunc.basicDec(idType.idNumber));
    ...
    console.log(`UserT : ${this.userType} , CustT : ${this.custType} , CustomerT : ${this.customerType}, refId : ${this.refId} , id : ${this.id}`);
  }

  coAppCheck() {
    this.sqliteProvider.getBasicDetails(this.refId, this.id).then(items => {
      ...
      if (age >= 18 && age < 23 || age >= 60 || emp == '4' || emp == '5' || emp == '6') {
        this.applicantDetails.get('coAppFlag').setValue('Y');
        this.disableCoApp = true;
    ...
    if (this.custType == 'E') {
      ...
      this.sqliteProvider.selectExData(urn).then(data => {
        ...
        if (format.test(data[0].AppFirstName)) {
          console.log("true");
          this.applicantDetails.controls.firstname.setValue(data[0].AppFirstName ? data[0].AppFirstName : "");
        } else {
          console.log("false");
          this.applicantDetails.controls.firstname.setValue(data[0].AppFirstName ? data[0].AppFirstName : "");
        }
        if (format.test(data[0].AppLastName)) {
          console.log("true");
          this.applicantDetails.controls.lastname.setValue(data[0].AppLastName ? data[0].AppLastName : "");
        } else {
          console.log("false");
          this.applicantDetails.controls.lastname.setValue(data[0].AppLastName ? data[0].AppLastName : "");
        }
        ...
        if (data[0].IdProof == "PAN") {
          this.applicantDetails.controls.panAvailable.setValue('Y');
          this.panAvailabilityChecking('Y');
          this.applicantDetails.controls.panNum.setValue(this.globFunc.basicDec(data[0].IdProofValue));
          this.applicantDetails.controls.panNum.updateValueAndValidity();
        } else if (data[0].PanNum != undefined || null || "") {
          this.applicantDetails.controls.panAvailable.setValue('Y');
          this.panAvailabilityChecking('Y');
          this.applicantDetails.controls.panNum.setValue(this.globFunc.basicDec(data[0].PanNum));
          this.applicantDetails.controls.panNum.updateValueAndValidity();
        }


        // this.applicantDetails.controls.panNum.setValue(this.globFunc.basicDec(data[0].PanNum) ? this.globFunc.basicDec(data[0].PanNum) : "");
        this.applicantDetails.controls.mobNum.setValue(this.globFunc.basicDec(data[0].Mobile) ? this.globFunc.basicDec(data[0].Mobile) : "");
        this.applicantDetails.controls.dob.setValue(data[0].DOB ? data[0].DOB.substring(0, 2) + "-" + data[0].DOB.substring(3, 5) + "-" + data[0].DOB.substring(6, 10) : '');
        this.applicantDetails.controls.fathername.setValue(data[0].FatherName ? data[0].FatherName : "");
        // this.applicantDetails.controls.mothername.setValue(data[0].MotherName ? data[0].MotherName: "");
        this.applicantDetails.controls.marital.setValue(data[0].MaritalStatus ? data[0].MaritalStatus : "");
        // this.applicantDetails.controls.spousename.setValue(data[0].FatherOrSpouse);
        this.applicantDetails.controls.gender.setValue(data[0].Gndr ? data[0].Gndr : "");
        // this.applicantDetails.controls.education.setValue(data[0].Education ? data[0].Education : "");
        this.applicantDetails.controls.email.setValue(this.globFunc.basicDec(data[0].Email) ? this.globFunc.basicDec(data[0].Email) : "");
        ...
        if (this.existAather) {
          ...
          let nameAsPerEkyc;
          if (aadharName) {
            nameAsPerEkyc = `${aadharName.name ? aadharName.name : ""} ${aadharName.lastname ? aadharName.lastname : ""}`
  ...
  setFilteredItems(panNumber) {
    if (this.userType == "G" || this.userType == "C") {
      ...
      // this.personalData.get('aadharNum').clearValidators();
      // this.personalData.get('aadharNum').setValidators(Validators.compose([Validators.maxLength(12), Validators.minLength(12), Validators.pattern('[0-9]{12}')]));
      this.personalData.get('panNum').setValidators(Validators.compose([Validators.maxLength(10), Validators.minLength(10), Validators.pattern(/^[a-zA-Z]{5}[0-9]{4}[a-zA-Z]{1}$/), Validators.required]));
      // this.personalData.get('aadharNum').setValue("");
      this.personalData.get('docName').clearValidators();
      this.personalData.get('docName').setValue("");
      this.personalData.get('docValue').clearValidators();
    ...
    if (value === "panCheck") {
      ...
      if (this.userType == 'G') {
        if (this.perId == '' || this.perId == null || this.perId == undefined) {
          this.personalData.get('panNum').setValidators(Validators.compose([Validators.maxLength(10), Validators.minLength(10), Validators.pattern(/^[a-zA-Z]{5}[0-9]{4}[a-zA-Z]{1}$/)]));
        } else {
          this.personalData.get('panNum').setValidators(Validators.compose([Validators.maxLength(10), Validators.minLength(10), Validators.pattern(/^[a-zA-Z]{5}[0-9]{4}[a-zA-Z]{1}$/)]));
        }
        this.personalData.get('docName').clearValidators();
      ...
      if (this.userType == 'A') {
        this.personalData.get('docName').setValidators(Validators.compose([Validators.required]));
        this.personalData.get('docName').setValue('VOTER');
        this.personalData.get('docValue').setValidators(Validators.compose([Validators.required]));
      }
      if (this.dbValue) {
        if (this.userType == 'A') {
          this.personalData.get('docName').setValidators(Validators.compose([Validators.required]));
  ...
  setDocvalidator(value, flag) {
    if (this.userType == 'A') {
      ...
      if (value == "VOTER") {
        ...
        this.personalData.get('docValue').setValidators(Validators.compose([Validators.maxLength(8), Validators.minLength(8), Validators.pattern(/^[a-zA-Z]{1}[0-9]{7}$/), Validators.required]));
      }
      else {
      ...
      if (value == "VOTER") {
        ...
        this.personalData.get('docValue').setValidators(Validators.compose([Validators.maxLength(8), Validators.minLength(8), Validators.pattern(/^[a-zA-Z]{1}[0-9]{7}$/)]));
      }
      else {
        console.log("no data recived for set doc validator");
      }
  ...
  personalSaveCheck(value) {
    ...
    if (custType == '1') {
      ...
      if (saveStatus == "sourcingSaved") {
        ...
        this.globalData.showAlert("Alert!", "Must Save Sourcing Details!");
      }
    } else {
      ...
      if (saveStatus == "entitySaved") {
        ...
        this.globalData.globalLodingDismiss();
        this.globalData.showAlert("Alert!", "Must Save Entity Details!");
      }
    }
  }
  ...
  personalsave(value) {
    ...
    if (calculatedYear < 21) {
      this.globalData.globalLodingDismiss();
      this.globalData.showAlert("Alert!", "The Customer Age should not be less than 21 years");
    } else {
      if (this.profPic) {
        ...
        if (this.userType == 'G') {
          if (this.perId) {
            this.sqliteProvider.updatePesonalDetails(this.refId, this.id, URNnumber, this.customerType, value, this.profPic, this.perId).then(data => {
              this.saveStatus.emit('personalTick');
              localStorage.setItem('Personal', 'personalSaved');
              this.globalData.globalLodingDismiss();
              this.globalData.showAlert("Alert!", "Guarantor Details Updated Successfully");
              this.formActivater.disableForm = true;
            ...
            this.sqliteProvider.insertSubmitDetails(this.refId, this.id, this.guacibilCheckStat, this.guasubmitStat, this.applicationNumber, this.applicationStatus, "G", "0", "0");
            this.sqliteProvider.addPersonalDetails(this.refId, this.id, URNnumber, this.customerType, value, this.profPic, this.userType, this.coAppGuaId, this.applType, this.custType, this.leadStatus, (this.firstNameDisable) ? 'Y' : 'N', (this.lastNameDisable) ? 'Y' : 'N', (this.disableFatherName) ? 'Y' : 'N', (this.dobDisable) ? 'Y' : 'N', (this.disableGender) ? 'Y' : 'N', (this.isNameAsPerEkyc) ? 'Y' : 'N', (this.ShowAadharDob) ? "Y" : "N", (this.disablePan) ? "Y" : "N", this.panName, this.panValidation, this.nameValidation, this.DOBValidation, this.seedingStatus).then(data => {
              ...
              this.globalData.showAlert("Alert!", "Guarantor Details Added Successfully");
              this.formActivater.disableForm = true;
              this.globFunc.setapplicationDataChangeDetector('saved', this.pagename);
          ...
          if (this.perId) {
            this.sqliteProvider.updatePesonalDetails(this.refId, this.id, URNnumber, this.customerType, value, this.profPic, this.perId).then(data => {
              ...
              localStorage.setItem('Personal', 'personalSaved');
              this.globalData.globalLodingDismiss();
              this.globalData.showAlert("Alert!", "Co-Applicant Details Updated Successfully");
              this.formActivater.disableForm = true;
              this.globFunc.setapplicationDataChangeDetector('saved', this.pagename);
            }).catch(Error => {
              this.globalData.globalLodingDismiss();
            ...
            this.sqliteProvider.insertSubmitDetails(this.refId, this.id, this.guacibilCheckStat, this.guasubmitStat, this.applicationNumber, this.applicationStatus, "C", "0", "0");
            this.sqliteProvider.addPersonalDetails(this.refId, this.id, URNnumber, this.customerType, value, this.profPic, this.userType, this.coAppGuaId, this.applType, this.custType, this.leadStatus, (this.firstNameDisable) ? 'Y' : 'N', (this.lastNameDisable) ? 'Y' : 'N', (this.disableFatherName) ? 'Y' : 'N', (this.dobDisable) ? 'Y' : 'N', (this.disableGender) ? 'Y' : 'N', (this.isNameAsPerEkyc) ? 'Y' : 'N', (this.ShowAadharDob) ? "Y" : "N", (this.disablePan) ? "Y" : "N", this.panName, this.panValidation, this.nameValidation, this.DOBValidation, this.seedingStatus).then(data => {
              this.perId = data.insertId;
              this.saveStatus.emit('personalTick');
              // this.globalData.setEditSaveStatus("personalSaved");
              ...
              this.globalData.globalLodingDismiss();
              localStorage.setItem('leadId', this.coAppGuaId);
              this.globalData.showAlert("Alert!", "Co-Applicant Details Added Successfully");
              this.formActivater.disableForm = true;
              this.globFunc.setapplicationDataChangeDetector('saved', this.pagename);
              this.sqliteProvider.updateCoAppFlag(this.refId, this.id);
            }).catch(Error => {
          ...
          if (this.perId) {
            this.sqliteProvider.updatePesonalDetails(this.refId, this.id, URNnumber, this.customerType, value, this.profPic, this.perId).then(data => {
              ...
              if (this.customerType == '2' && this.userType == 'A') {
                this.globalData.showAlert("Alert!", "Promoter Details Updated Successfully");
                this.formActivater.disableForm = true;
                this.globFunc.setapplicationDataChangeDetector('saved', this.pagename);
              } else {
                this.globalData.showAlert("Alert!", "Applicant Details Updated Successfully");
                this.formActivater.disableForm = true;
                this.globFunc.setapplicationDataChangeDetector('saved', this.pagename);
              }
            }).catch(Error => {
            ...
            this.sqliteProvider.insertSubmitDetails(this.refId, this.id, this.guacibilCheckStat, this.guasubmitStat, this.applicationNumber, this.applicationStatus, "A", "0", "0");
            this.sqliteProvider.addPersonalDetails(this.refId, this.id, URNnumber, this.customerType, value, this.profPic, this.userType, this.coAppGuaId, this.applType, this.custType, this.leadStatus, (this.firstNameDisable) ? 'Y' : 'N', (this.lastNameDisable) ? 'Y' : 'N', (this.disableFatherName) ? 'Y' : 'N', (this.dobDisable) ? 'Y' : 'N', (this.disableGender) ? 'Y' : 'N', (this.isNameAsPerEkyc) ? 'Y' : 'N', (this.ShowAadharDob) ? "Y" : "N", (this.disablePan) ? "Y" : "N", this.panName, this.panValidation, this.nameValidation, this.DOBValidation, this.seedingStatus).then(data => {
              //  (value.coAppFlag == 'Y') ? this.sqliteProvider.updateCoAppFlag(this.refId,this.id) : '';
              this.perId = data.insertId;
              this.saveStatus.emit('personalTick');
              ...
              localStorage.setItem('leadId', this.coAppGuaId);
              if (this.customerType == '2' && this.userType == 'A') {
                this.globalData.showAlert("Alert!", "Promoter Details Added Successfully");
                this.formActivater.disableForm = true;
                this.globFunc.setapplicationDataChangeDetector('saved', this.pagename);
              } else {
                this.globalData.showAlert("Alert!", "Applicant Details Added Successfully");
                this.formActivater.disableForm = true;
                this.globFunc.setapplicationDataChangeDetector('saved', this.pagename);
              }
        ...
        if (this.applicantDetails.controls.panAvailable.value == 'Y') {
          this.sqlSupport.getAfterBasicPromoterProof(this.refId, this.id, "1556814", "PAN CARD").then(data => {
            if (data.length > 0) {
              this.sqlSupport.updateAfterBasicProof(this.applicantDetails.controls.panNum.value, this.refId, this.id, "1556814", "PAN CARD")
            }
          })
        } else {
          this.sqlSupport.removeAfterBasicProof(this.refId, this.id, "1556814", "PAN CARD")
        }

      } else {
        this.globalData.globalLodingDismiss();
        this.globalData.showAlert("Alert!", "Must Capture the Profile Image!");
      }
    }
  ...
  getPersonalDetails() {
    this.sqliteProvider.getJanarefSourcingDetails(this.refId, 'A').then(data => {
      if (data.length > 0) {
      ...
      this.sqliteProvider.getPersonalDetails(this.refId, this.id).then(data => {
        if (data.length > 0) {
          ...
          if ((this.getPersonalData[0].employment == '1') && ((this.janaEmp != '1') || (this.userType == 'C'))) {
            this.isSelfEmp = false;
            this.isSalaried = true;
            ...
            this.isSalaried = false;
            this.isJanaEmp = false;
          } else if ((this.getPersonalData[0].employment == '1') && (this.janaEmp == '1') && (this.userType == 'A')) {
            this.isSalaried = true;
            this.isJanaEmp = true;
            this.isSelfEmp = false;
          }
          ...
          this.applicantDetails.controls.genTitle.setValue(this.getPersonalData[0].genTitle);
          this.applicantDetails.controls.firstname.setValue(this.getPersonalData[0].firstname);
          this.applicantDetails.controls.middlename.setValue(this.getPersonalData[0].middlename);
          this.applicantDetails.controls.lastname.setValue(this.getPersonalData[0].lastname);
          this.applicantDetails.controls.fathername.setValue(this.getPersonalData[0].fathername);
          this.applicantDetails.controls.spouseName.setValue(this.getPersonalData[0].spouseName);
          this.applicantDetails.controls.dob.setValue(this.getPersonalData[0].dob);
          this.applicantDetails.controls.dobAadhar.setValue(this.getPersonalData[0].dobAadhar);
          this.applicantDetails.controls.dobDocument.setValue(this.getPersonalData[0].dobDocument);
          this.applicantDetails.controls.marital.setValue(this.getPersonalData[0].marital);
          this.applicantDetails.controls.gender.setValue(this.getPersonalData[0].gender);
          this.applicantDetails.controls.mobNum.setValue(this.globFunc.basicDec(this.getPersonalData[0].mobNum));
          this.applicantDetails.controls.altMobNum.setValue(this.globFunc.basicDec(this.getPersonalData[0].altMobNum));
          this.applicantDetails.controls.panAvailable.setValue(this.getPersonalData[0].panAvailable);
          this.applicantDetails.controls.panNum.setValue(this.globFunc.basicDec(this.getPersonalData[0].panNum));
          this.applicantDetails.controls.form60.setValue(this.globFunc.basicDec(this.getPersonalData[0].form60));
          this.applicantDetails.controls.employment.setValue(this.getPersonalData[0].employment);
          this.applicantDetails.controls.bussName.setValue(this.getPersonalData[0].bussName);
          this.applicantDetails.controls.actDetail.setValue(this.getPersonalData[0].actDetail);
          this.applicantDetails.controls.monthIncome.setValue(this.getPersonalData[0].monthIncome);
          this.applicantDetails.controls.vinOfServ.setValue(this.getPersonalData[0].vinOfServ);

          this.applicantDetails.controls.employerName.setValue(this.getPersonalData[0].employerName);
          this.applicantDetails.controls.employeeId.setValue(this.getPersonalData[0].employeeId);
          this.applicantDetails.controls.designation.setValue(this.getPersonalData[0].designation);
          this.applicantDetails.controls.joinDate.setValue(this.getPersonalData[0].joinDate);
          this.applicantDetails.controls.monthSalary.setValue(this.getPersonalData[0].monthSalary);
          this.applicantDetails.controls.lmName.setValue(this.getPersonalData[0].lmName);
          this.applicantDetails.controls.lmEmail.setValue(this.globFunc.basicDec(this.getPersonalData[0].lmEmail));

          this.applicantDetails.controls.experience.setValue(this.getPersonalData[0].experience);
          this.applicantDetails.controls.annualIncome.setValue(this.getPersonalData[0].annualIncome);
          this.applicantDetails.controls.caste.setValue(this.getPersonalData[0].caste);
          this.applicantDetails.controls.religion.setValue(this.getPersonalData[0].religion);
          this.applicantDetails.controls.languages.setValue(this.getPersonalData[0].languages);
          this.applicantDetails.controls.resciStatus.setValue(this.getPersonalData[0].resciStatus);
          this.applicantDetails.controls.education.setValue(this.getPersonalData[0].education);
          this.applicantDetails.controls.email.setValue(this.globFunc.basicDec(this.getPersonalData[0].email));
          this.applicantDetails.controls.coAppFlag.setValue(this.getPersonalData[0].coAppFlag);
          this.applicantDetails.controls.nameEkyc.setValue(this.getPersonalData[0].nameAsPerEkyc);
          if (this.getPersonalData[0].upiNo) {
            this.applicantDetails.controls.upiNo.setValue(this.getPersonalData[0].upiNo);
            this.applicantDetails.controls.nameupi.setValue(this.getPersonalData[0].nameupi);
            this.getPersonalData[0].nameupi.length > 0 ? this.upiVerify = true : this.upiVerify = false;
          }
          ...
          this.profPic = this.globalData.setProfileImage(this.getPersonalData[0].profPic);
          this.saveStatus.emit('personalTick');
          // this.globalData.setEditSaveStatus("personalSaved");
          localStorage.setItem('Personal', 'personalSaved');
          if (this.getPersonalData[0].panAvailable == 'Y') {
            this.setFilteredItems(this.globFunc.basicDec(this.getPersonalData[0].panNum));
          } else if (this.getPersonalData[0].panAvailable == 'N') {
            this.setFilteredItems(this.globFunc.basicDec(this.getPersonalData[0].form60));
          }
          this.panAvailabilityChecking(this.getPersonalData[0].panAvailable);
          // this.\(undefined);
        } else {
          this.userType = this.globalData.getborrowerType();
  ...
  postData() {
    ...
    this.master.restApiCallAngular('validatePan', body).then((data) => {
      this.globFunc.globalLodingDismiss();
      if ((<any>data).NSDL.Response.details.StatusCode == "1" && (<any>data).NSDL.Response.details.Panstatus == "E") {
        this.panResult = (<any>data).NSDL.Response.details;
        this.PANCheckStatus = "Y";
        this.panName = this.panResult.firstName + " " + this.panResult.middleName + " " + this.panResult.lastName;
      } else {
        this.panResult = undefined;
        this.globalData.showAlert("Alert!", "Not a valid PAN !");
      }
    }, (err) => {
      this.globFunc.globalLodingDismiss();
  ...
  sendSms() {
    if (this.network.type === 'none' || this.network.type == 'unknown') {
      ...
      if (this.otpCount > 3) {
        ...
        //   .subscribe(data => {
        this.master.restApiCallAngular('Smsotp', body).then((data) => {
          this.globFunc.globalLodingDismiss();
          ...
          if (this.urlType) {
            ...
            this.globalData.showAlert("Alert!", "OTP Sent to Entered Mobile number Success!");
          } else {
            if ((<any>data).SMS.Response.statusCode === 'Success') {
              ...
              this.globalData.showAlert("Alert!", "Not a valid Mobile number");
            }
          }
        }, (err) => {
          this.globFunc.globalLodingDismiss();
  ...
  checkOTP(value) {
    ...
    if (this.OTPNUM === value) {
      ...
      this.globalData.showAlert("Alert!", "Mobile Number verified Successfully!");
    } else if (this.OTPNUM != value) {
      this.verifiedMobNum = false;
      this.personalData.get('enteredOTP').setValue('');
      this.enteredOTP = '';
      this.globalData.showAlert("Alert!", "Please enter valid OTP");
    } else if (value === '' || value === undefined || value === null) {
      this.verifiedMobNum = false;
      this.globalData.showAlert("Alert!", "Please enter OTP");
    }
  }
  ...
  panadProofupdate(aadharNum, panNum, docName, docValue) {
    if (aadharNum == "" || aadharNum == undefined || aadharNum == null) {
      if (panNum != "" && panNum != undefined && panNum != null) {
        this.sqliteProvider.adProofupdate(this.refId, this.id, 'PAN', panNum).then(data => {
        ...
        this.sqliteProvider.adProofupdate(this.refId, this.id, docName, docValue).then(data => {
          // console.log("pan data ==>"+data);
        }).catch(Error => {
          console.log("Failed!" + Error);
          //this.showAlert("Alert!", "Failed!");
      ...
      this.sqliteProvider.adProofupdate(this.refId, this.id, 'ad', aadharNum).then(data => {
  ...
  panHideGuaran() {
    if (this.personalData.controls['aadharNum'].valid) {
      ...
      this.personalData.get('aadharNum').setValidators(Validators.compose([Validators.maxLength(12), Validators.pattern('[0-9]{12}')]));
      this.panform60 = "panCheck";
      this.personalData.get('panNum').setValidators(Validators.compose([Validators.maxLength(10), Validators.minLength(10), Validators.pattern(/^[a-zA-Z]{5}[0-9]{4}[a-zA-Z]{1}$/), Validators.required]));
      if (this.userType == 'A') {
        this.panform60 = "panCheck";
  ...
  panAvailabilityChecking(value) {
    ...
    if (event == 'Y') {
      this.applicantDetails.controls.panNum.setValidators(Validators.compose([Validators.maxLength(10), Validators.minLength(10), Validators.pattern(/^[a-zA-Z]{5}[0-9]{4}[a-zA-Z]{1}$/), Validators.required]));
      this.applicantDetails.controls.panNum.updateValueAndValidity();
      ...
      if (this.naveParamsValue.pan) {
        ...
        this.disablePan = true;
      } else if (this.ExCusData.length > 0 && this.ExCusData[0].IdProof == "PAN") {
        this.applicantDetails.controls.panNum.setValue(this.globFunc.basicDec(this.ExCusData[0].IdProofValue));
        this.applicantDetails.controls.panNum.updateValueAndValidity();
        this.panNumber = this.globFunc.basicDec(this.ExCusData[0].IdProofValue);
        this.disablePan = true;
      } else if (this.ExCusData.length > 0 && this.ExCusData[0].PanNum != undefined || null || "") {
        this.applicantDetails.controls.panNum.setValue(this.globFunc.basicDec(this.ExCusData[0].PanNum));
        this.applicantDetails.controls.panNum.updateValueAndValidity();
  ...
  getEmploymentValue() {
    this.sqliteProvider.getMasterDataUsingType('OccupationTwovl').then(data => {
  ...
  getResStatus() {
    this.sqliteProvider.getMasterDataUsingType('ResidenceStatus').then(data => {
  ...
  getVintageofService() {
    this.sqliteProvider.getMasterDataUsingType('VintageofService').then(data => {
  ...
  karzaDataFetch() {
    if (this.naveParamsValue.licence) {
      ...
      this.applicantDetails.controls.middlename.setValue(this.idType.middlename);
      this.applicantDetails.controls.lastname.setValue(this.idType.lastname);
      this.applicantDetails.controls.fathername.setValue(this.idType.fathername);
      this.applicantDetails.controls.dob.setValue(this.idType.dob.substring(6, 10) + "-" + this.idType.dob.substring(3, 5) + "-" + this.idType.dob.substring(0, 2));
    } else if (this.naveParamsValue.passport) {
      ...
      if (this.idType.proEmail != "" && this.idType.proEmail != undefined && this.idType.proEmail != null) {
        this.applicantDetails.controls.panAvailable.setValue('Y');
      ...
      // }
      if (this.idType.panDOB != "" && this.idType.panDOB != null && this.idType.panDOB != undefined) {
        this.applicantDetails.controls.dob.setValue(this.idType.panDOB.substring(6, 10) + "-" + this.idType.panDOB.substring(3, 5) + "-" + this.idType.panDOB.substring(0, 2));
      }
      this.applicantDetails.controls.panAvailable.setValue('Y');
      this.panAvailabilityChecking('Y');
      this.applicantDetails.controls.panNum.setValue(this.idType.idNumber);
  ...
  mobNumValidation() {
    if (this.applicantDetails.controls.mobNum.value.length == 10) {
      ...
      if (str[0] == str[1] && str[0] == str[2] && str[0] == str[3] && str[0] == str[4] && str[0] == str[5] && str[0] == str[6] && str[0] == str[7] && str[0] == str[8] && str[0] == str[9]) {
        ...
        this.globalData.showAlert("Alert!", "Given mobile number is not valid!");
      }
    }
  }
  ...
  empStatusCheck(event) {
    ...
    //   this.disableCoApp = true;
    // } else
    if ((val == '1') && ((this.janaEmp != '1') || (this.userType == 'C'))) {// isSalaried - employerName,employeeId, designation, joinDate, experience, monthSalary
      this.isSelfEmp = false;
      this.isSalaried = true;
      this.isJanaEmp = false;
      ...
      this.applicantDetails.get('employerName').setValidators(Validators.required);
      // this.applicantDetails.get('employeeId').setValidators(Validators.required);
      this.applicantDetails.get('designation').setValidators(Validators.required);
      this.applicantDetails.get('joinDate').setValidators(Validators.required);
      this.applicantDetails.get('experience').setValidators(Validators.required);
      this.applicantDetails.get('monthSalary').setValidators(Validators.required);
    ...
    } else if ((val == '1') && (this.janaEmp == '1') && (this.userType == 'A')) {// isSalaried & isJanaEmp  - employerName,employeeId, designation, joinDate, experience, monthSalary, lmName, lmEmail
      this.isSelfEmp = false;
      this.isSalaried = true;
      this.isJanaEmp = true;
      ...
      this.applicantDetails.get('lmEmail').setValidators([Validators.compose([Validators.pattern('^[A-Z0-9a-z\\._%+-]+@([A-Za-z0-9-]+\\.)+[A-Za-z]{2,4}$'), Validators.required])]);
    ...
    } else if (val == "2") { //isSelfEmp - bussName, actDetail, monthIncome, vinOfServ
      this.isSelfEmp = true;
      this.isSalaried = false;
      this.isJanaEmp = false;
      ...
      this.applicantDetails.get('monthIncome').setValidators(Validators.required);
  ...
  maritalStatus(value) {
    if (value == '1') {
      this.applicantDetails.get('spouseName').setValidators(Validators.compose([Validators.maxLength(30), Validators.pattern('[a-zA-Z ]*')]));
  ...
  EkycDataFetch() {
    if (this.naveParamsValue.ekycData) {
      ...
      if (isMatch(EkycData.dob, "yyyy-MM-dd")) {
        ...
        this.ShowAadharDob = false;
        this.applicantDetails.controls.dob.setValue(EkycData.dob.substring(6, 10) + "-" + EkycData.dob.substring(3, 5) + "-" + EkycData.dob.substring(0, 2));
        this.applicantDetails.get('dobAadhar').setValue('');
        this.applicantDetails.get('dobAadhar').clearValidators();
        this.applicantDetails.get('dobAadhar').updateValueAndValidity();
        this.applicantDetails.get('dobDocument').setValue('');
        ...
        this.applicantDetails.get('dobAadhar').updateValueAndValidity();
        this.applicantDetails.get('dobDocument').setValidators(Validators.required);
        this.applicantDetails.get('dobDocument').updateValueAndValidity();
      }
    ...
    this.sqliteProvider.getKarzaData(this.leadId, 'pan').then(data => {
      if (data.length > 0) {
        if (data[0].idType == 'pan') {
          this.applicantDetails.controls.panAvailable.setValue('Y');
          this.applicantDetails.controls.panNum.setValue(this.globFunc.basicDec(data[0].idNumber));
...
*/
  async fetchUPIDetails() {
    try {
      ...
      await this.master.restApiCallAngular('upiValidation', request).then((result) => {
        if (result != undefined && result != null && result != '') {
          this.globalData.globalLodingDismiss();
          if ((<any>result).errorCode === '0' && (<any>result).verifyFlag == 'Y') {
            this.upiVerify = true;
            this.applicantDetails.controls.nameupi.setValue((<any>result).nameAsPerBank);
  ...
  WorkingExperienceCalculation() {
    ...
    const totalExperienceInYears = +this.applicantDetails.controls.experience.value; // Example: 4.5 years
    ...
    const decimalExperience = yearsOfExperience + (monthsOfExperience / 12) + (daysOfExperience / 365);

    // Validate the experience
    if (decimalExperience.toFixed(1) === totalExperienceInYears.toFixed(1)) {
      console.log("Experience is valid.");
    } else {
      console.log(`Experience is not valid. Actual experience: ${decimalExperience.toFixed(1)} years.`);
    }
